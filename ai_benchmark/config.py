...
class Test:
    ...
    def __init__(self, test_id, test_type, model, model_src, use_src, tests_training, tests_inference, tests_micro, tests_nano):
    ...
    def getTests(self, batch_mul=1):
        ...
        benchmark_tests = [
            ...
            Test(test_id=13, test_type="segmentation", model="Nvidia-SPADE", model_src="spade.meta", use_src=False,
                 tests_training=[SubTest(1*batch_mul, [128, 128, 3], [128, 128, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=200)],
                 tests_inference=[
            ...
            Test(test_id=15, test_type="segmentation", model="PSPNet", model_src="pspnet.meta", use_src=False,
                 tests_training=[SubTest(1*batch_mul, [512, 512, 3], [64, 64, 3], 22, min_passes=5, max_duration=30,
                 ...
                 tests_nano=[SubTest(1, [720, 720, 3], [90, 90, 3], 22, min_passes=5, max_duration=30, ref_time=103)]),
